...
namespace CommonLibrary
{
    ...
    /// </summary>
    public class LocalizedExceptionManager : ExceptionManagerDefault, ILocalizedExceptionManager
    {
        /// <summary>
        ...
        /// <param name="resources"></param>
        /// <param name="errors"></param>
        public void Handle(string errorDescriptor, ILocalizedResourceManager resources, Exception ex, string[] args)
        {
            string error = resources.GetString(errorDescriptor);
            string errorDetails = error;
